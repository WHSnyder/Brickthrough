...
img1 = cv2.imread('/Users/will/Desktop/pole.png',cv2.IMREAD_GRAYSCALE)          # queryImage
img2 = cv2.imread('/Users/will/Desktop/pole1.png',cv2.IMREAD_GRAYSCALE) # trainImage
...
img3 = cv2.drawMatches(img1,kp1,img2,kp2,matches[:4],None,flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
plt.imshow(img3),plt.show()
